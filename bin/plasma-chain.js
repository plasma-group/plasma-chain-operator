...
You can use a faucet to get test ETH for free here: ${
  'https://faucet.rinkeby.io/'.green
}`
const rinkebyStep3 = `${
  '$ plasma-chain deploy'.green
} # deploys a new Plasma Chain.
...
const customStep2 =
  '# On your Ethereum node, send your new Operator address ~0.5 ETH'
const customStep3 = `${
  '$ plasma-chain deploy [-n]'.green
} # deploys a new Plasma Chain. If you want
...
You can set your Ethereum node in your config file located: ${
  configFile.toString().yellow
}
...
[optional]
5) ${
  '$ plasma-chain testSwarm'.green
} # spam your Plasma Chain with tons of test transactions 😁
